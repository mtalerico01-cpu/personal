...
/** Sparkles — universal AI-generated content marker (Heroicons design used by Apple, Stripe, Linear) */
export function SparklesIcon({ color, size = 16 }: NavIconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
...
/** Lightbulb — AI / Coach insight indicator */
export function LightbulbIcon({ color, size = 14 }: NavIconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
...
export function ProfileIcon({ color, size = 24 }: NavIconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
